...
class SourcePesertaDtks {
  ...
  static Future<List<PesertaDtks>> gets() async {
    ...
    if (responseBody != null) {
      ...
      if (result['success']) {
        ...
        return list.map((e) => PesertaDtks.fromJson(e)).toList();
      }
      return [];
    }
    return [];
  ...
  //1*
  static Future<List<PesertaDtks>> getsDtks(
  ...
  static Future<List<DtksImages>> getImage(
