...
class UploadPhoto extends StatefulWidget {
  ...
  const UploadPhoto(this.kodeNik, {key, required this.mode, required this.tahun, required this.bulan, required this.tahap, required this.batch, required this.gelombang}) : super(key: key);
...
class _UploadPhotoState extends State<UploadPhoto> {
  ...
  Future sendImage(ImageSource media) async {
    ...
    var uri = "${Api.pesertaDtks}/upload_photo.php?nik=${widget.kodeNik}&tahun=${widget.tahun}&bulan=${widget.bulan}&tahap=${widget.tahap}&batch=${widget.batch}&gelombang=${widget.gelombang}&lat=$nLat&lng=$nLng&mode=${widget.mode}";
