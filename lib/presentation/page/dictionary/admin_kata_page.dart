...
class AdminKataPage extends StatefulWidget {
  // final String kriteria;
  // const AdminKataPage(this.kriteria, {key}) : super(key: key);
  ...
  @override
  State<AdminKataPage> createState() => _AdminKataPageState();
}

class _AdminKataPageState extends State<AdminKataPage> {
  ...
  getListAll() {
    ...
    //cKamusKata.setListKataPaging(page, limit);
  }
    ...
    return Scaffold(
      ...
      body: Obx(() {
        return ListView.builder(
          itemCount: cKamusKata.listKata.length + 1,
          itemBuilder: (context, index) {
            if (index < cKamusKata.listKata.length) {
              var dataKamusKata = cKamusKata.listKata[index];
              return ListTile(
                  // title: Text(dataKamusKata.kata!.toUpperCase()),
                  // subtitle: Text(
                  //     '${dataKamusKata.keterangan} ==> ${dataKamusKata.keterangan2}'),
                  ...
                  trailing: PopupMenuButton<String>(
                    ...
                    itemBuilder: (context) => [
                      PopupMenuItem(
                          value: 'gambar1',
                          child: Text('uploadSignalImage'.tr)),
                      PopupMenuItem(
                          value: 'gambar2',
                          child: Text('uploadCaptionImage'.tr)),
                      PopupMenuItem(
                          value: 'gambar3',
            ...
            } else if (cKamusKata.hasMore.value) {
              cKamusKata.fetchKatas();
              return const Center(child: CircularProgressIndicator());
            } else {
              return const Center(child: Text('No more result'));
            }
          },
        );
      }),

      // GetBuilder<CKata>(builder: (_) {
