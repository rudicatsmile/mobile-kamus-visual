...
class UploadImageKataPage extends StatefulWidget {
  // const UploadImageKataPage({Key? key}) : super(key: key);
  ...
  const UploadImageKataPage(this.kodeNik,
      {key,
      required this.mode,
      required this.tahun,
      required this.bulan,
  ...
  @override
  State<UploadImageKataPage> createState() => _UploadImageKataPageState();
}

class _UploadImageKataPageState extends State<UploadImageKataPage> {
